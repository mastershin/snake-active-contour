...
var SnakeKineticEngine = function () {
    ...
    this.orig_click = function (fn) {
        stages["Orig"].getContent().addEventListener('click', fn);
    }
    this.getMousePosition = function(name) {
        return stage[name].getMousePosition();
    }
    ...
    function initCanvas(orig, result, line, edge, term, width, height) {
        stages["Orig"] = new Kinetic.Stage({
            container: orig,
            width: width,
            height: height
        });
        stages["Result"] = new Kinetic.Stage({
            container: result,
            width: width,
            height: height
        });
        stages["LineFunc"] = new Kinetic.Stage({
            container: line,
            width: width,
            height: height
        });
        stages["EdgeFunc"] = new Kinetic.Stage({
            container: edge,
            width: width,
            height: height
        });    
        stages["TermFunc"] = new Kinetic.Stage({
            container: term,
            width: width,
            height: height
        });
